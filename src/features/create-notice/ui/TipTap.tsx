...
const Tiptap = forwardRef(
  ({ content, onChange, onAddImage }: TiptapProps, ref) => {
        ...
        <div className={styles.toolbar}>
          ...
          <button onClick={() => editor?.chain().focus().toggleBold().run()}>
            ...
            >
              <path
                ...
                fill={editorState?.isBold ? "#51C37E" : "#3A3A3A"}
              />
            </svg>
          </button>
          {/* 이탤릭 */}
          <button onClick={() => editor?.chain().focus().toggleItalic().run()}>
            ...
            >
              <path
                ...
                fill={editorState?.isItalic ? "#51C37E" : "#3A3A3A"}
              />
              <path
          ...
          >
            ...
            >
              <path
                ...
                fill={editorState?.isUnderline ? "#51C37E" : "#3A3A3A"}
              />
              <path
          ...
          <button onClick={() => editor?.chain().focus().toggleStrike().run()}>
            ...
            >
              <path
                ...
                fill={editorState?.isStrike ? "#51C37E" : "#3A3A3A"}
              />
              <path
          ...
          >
            ...
            >
              <path
                d="M4 5H20"
                stroke={editorState?.isLeft ? "#51C37E" : "#3A3A3A"}
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
          ...
          >
            ...
            >
              <path
                d="M4 5H20"
                stroke={editorState?.isCenter ? "#51C37E" : "#3A3A3A"}
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
          ...
          >
            ...
            >
              <path
                d="M4 5H20"
                stroke={editorState?.isRight ? "#51C37E" : "#3A3A3A"}
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
          ...
          >
            ...
            >
              <path
                d="M4 5H20"
                stroke={editorState?.isJustify ? "#51C37E" : "#3A3A3A"}
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
          ...
          >
            ...
            >
              <path
                d="M10 5H20"
                stroke={editorState?.isBulletList ? "#51C37E" : "#3A3A3A"}
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              ...
              <circle
                ...
                cy="19"
                r="2"
                fill={editorState?.isBulletList ? "#51C37E" : "#3A3A3A"}
              />
              <circle
                cx="5"
                cy="12"
          ...
          >
            ...
            >
              <path
                d="M10 8H20"
                stroke={editorState?.isOrderedList ? "#51C37E" : "#3A3A3A"}
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
          ...
          >
            ...
            >
              <rect
                ...
                height="7"
                rx="1.5"
                fill={editorState?.isBlockquote ? "#51C37E" : "#3A3A3A"}
                stroke={editorState?.isBlockquote ? "#51C37E" : "#3A3A3A"}
              />
              <rect
                x="13.5"
                y="11.5"
